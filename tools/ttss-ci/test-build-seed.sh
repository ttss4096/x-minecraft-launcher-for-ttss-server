...
for name in hailwall_1.0.3-versionlock.1_neoforge_1.21.1.jar sablecollisiondamage-1.0.8.jar ttss-exclusive-client-neoforge-1.21.1-1.0.1.jar new.jar; do
...
jq -n --argjson list "$manifest_list" '{automodpackVersion: "4.0.6", mcVersion: "1.21.1", loader: "neoforge", loaderVersion: "21.1.236", modpackName: "fixture", list: $list, nonModpackFilesToDelete: [{file: "/mods/stale.jar", sha1: "0123456789abcdef0123456789abcdef01234567", timestamp: "1786700000000"}, {file: "/mods/ttss-exclusive-client-neoforge-1.21.1-1.0.0.jar", sha1: "0123456789abcdef0123456789abcdef01234567", timestamp: "1786700000000"}]}' > "$export_root/host/automodpack-content.json"
...
unzip -Z1 "$work/out1/ttss-client-seed.zip" | grep -Fx 'mods/ttss-exclusive-client-neoforge-1.21.1-1.0.0.jar' && exit 1 || true
unzip -Z1 "$work/out1/ttss-client-seed.zip" | grep -Fx 'mods/ttss-exclusive-client-neoforge-1.21.1-1.0.1.jar' >/dev/null
